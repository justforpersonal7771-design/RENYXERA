                  ...
                  <div className="flex-none px-4 py-2 sm:px-6 flex flex-col sm:flex-row justify-between items-center border-t border-[var(--border)] bg-[var(--surface)]/95 backdrop-blur z-20 gap-2">
                    <div className="flex gap-2 sm:gap-3 w-full sm:w-auto">
                      <button
                        ...
                        className="group flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-violet-500/10 text-violet-700 dark:text-violet-300 hover:bg-violet-500/20 border border-violet-500/25 rounded-xl text-sm font-semibold transition active:scale-[0.97] cursor-pointer"
                      >
