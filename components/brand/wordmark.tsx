 ...
 * the app; this is set in the app's own display font (Sora), stays crisp at any size,
...
export function Wordmark({ className = "", size = "md" }: { className?: string; size?: "sm" | "md" | "lg" | "xl" }) {
  ...
  return (
    <span
      aria-label="RENYXERA"
      className={`font-display font-extrabold tracking-[0.14em] leading-none select-none whitespace-nowrap ${sizes[size]} ${className}`}
    >
